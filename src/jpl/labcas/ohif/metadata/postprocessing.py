...
'''🔬 OHIF LabCAS metadata postprocessing for DICOM files.

This time we extract yet more metadata, and loads huge chunks of it into Solr.
'''


from ._argparse import add_standard_argparse_options
from ._process import postprocess
...
def main():
    ...
    # Ready to go!
    postprocess(solr, folder, prefix, generator)
    sys.exit(0)
